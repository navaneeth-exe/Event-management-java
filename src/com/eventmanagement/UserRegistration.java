...
public class UserRegistration {
    public static int registerUser(User user) {
        int generatedId = -1; // To store the generated ID (eventManagerId or adminId)
        ...
        try {
            ...
            if (user instanceof EventManagerUser) {
                ...
                query = "INSERT INTO EventManager (eventManagerName, userId) VALUES (?, ?)";
                stmt = conn.prepareStatement(query, Statement.RETURN_GENERATED_KEYS);
                stmt.setString(1, eventManager.getEventManagerName());
                stmt.setInt(2, userId); 
                stmt.executeUpdate();

                // Get the generated eventManagerId
                ...
                query = "INSERT INTO Admin (adminName, userId) VALUES (?, ?)";
                stmt = conn.prepareStatement(query, Statement.RETURN_GENERATED_KEYS);
                ...
                query = "INSERT INTO Participant (participantName, userId, phoneNumber) VALUES (?, ?, ?)";
                stmt = conn.prepareStatement(query, Statement.RETURN_GENERATED_KEYS);
                ...
                // Get the generated participantId
                generatedKeys = stmt.getGeneratedKeys();
                if (generatedKeys.next()) {
                    generatedId = generatedKeys.getInt(1);
                }
        ...
        return generatedId; // Return the generated eventManagerId or adminId
    }
}